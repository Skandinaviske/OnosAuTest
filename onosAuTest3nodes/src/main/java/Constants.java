public class Constants {
    ...
    public static final String gitOnosSystemtest = "git clone https://github.com/Skandinaviske/OnosSystemTest.git";
    ...
    public static final String installconfigObj = "sudo pip install configObj";
