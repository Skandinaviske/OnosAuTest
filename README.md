...
You can get the source code from onosAuTest1node folder, onosAuTest3node folder, Starttest folder, CleanupMachine folder, SetupMininetMachine folder, SetupTargetMachine folder.
